...
from etl.jobs.extract import GoldExtractor
from etl.jobs.transform import GoldTransformer
from etl.jobs.load import GoldLoader
from utils import get_etl_logger, ProcessTimer
...
class GoldPipeline:
    ...
    def run(self):
        ...
        with ProcessTimer(logger, "Extração"):
            df_silver = self.extractor.extract_silver_table(
